<?php
    ...
    class SkinRenderer
    {
         ...
         */
        public function renderSkinFromPath($skin_path, $skin_type = 'steve', $skin_side = 'front', $skin_overlay = true)
        {
            // Load the skin
            ...
            return $this->renderSkinFromResource($skin, $skin_type, $skin_side, $skin_overlay);
        }
         ...
         *         You can use it with functions like imagepng.
         */
        public function renderSkinFromResource($skin, $skin_type = 'steve', $skin_side = 'front', $skin_overlay = false)
        {
